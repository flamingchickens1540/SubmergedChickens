...
>
    <div
        class="no-scrollbar absolute inset-x-0 bottom-0 flex min-h-[50svh] max-h-[80svh] w-dvw flex-col items-center gap-3 overflow-y-scroll rounded-t-lg bg-gunmetal p-3 text-white"
        id="timeline"
    >
        {#each actions as _, i}
            <Action
